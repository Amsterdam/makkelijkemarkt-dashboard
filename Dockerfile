...
# project setup
COPY . /srv/web/makkelijke_markt_dashboard
WORKDIR /srv/web

# nginx and php setup
#COPY Docker/makkelijke_markt_dashboard.vhost /etc/nginx/conf.d/makkelijke_markt_dashboard.vhost.conf

COPY /Docker/parameters.yml /srv/web/brievenhulp/app/config/parameters.yml

RUN wget https://getcomposer.org/composer.phar \
  && php composer.phar install -d makkelijke_markt_dashboard \
...
#COPY Docker/config.php /srv/web/makkelijke_markt_dashboard/makkelijke_markt_dashboard/app/config/
