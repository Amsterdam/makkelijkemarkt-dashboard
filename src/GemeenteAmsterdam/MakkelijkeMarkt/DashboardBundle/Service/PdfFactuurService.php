...
class PdfFactuurService
{
    ...
    public function __construct($container)
    {
        ...
        $this->fontnameBold = \TCPDF_FONTS::addTTFfont(
            getcwd() . '/../src/GemeenteAmsterdam/MakkelijkeMarkt/DashboardBundle/Resources/public/fonts/Avenir-Heavy.ttf',
            'TrueTypeUnicode',
            '',
            96
        );
    ...
    public function generate($koopman, $dagvergunningen, \DateTime $startDate, \Datetime $endDate) {
